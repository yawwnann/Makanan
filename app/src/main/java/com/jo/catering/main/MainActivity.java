...
import com.jo.catering.history.HistoryOrderActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setInitLayout() {
        ...
        mapsButton = findViewById(R.id.button_maps);
    ...
    private void setCategories() {
        modelCategories = new ModelCategories(R.drawable.prasmanann, "Paket Lengkap");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.hemat, "Paket Hemat");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.sayur, "Paket Sehat");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.fastfod, "Makanan Cepat Saji");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.event, "Paket Event");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.ic_more_food, "Lainnya");
        modelCategoriesList.add(modelCategories);
